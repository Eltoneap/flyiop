...
**Estado do código:** commit `be81384` (`sql/etapa4_1_estado_por_usuario.sql` + `sql/etapa4_1_verificacao.sql`) — **commitado localmente, pendente de push** na data deste registro. A estrutura, porém, **existe no banco de produção**: o script foi rodado à mão no SQL Editor, não pelo repositório.
